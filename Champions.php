...
<html>
    ...
    <body class="dark">
        <article id="ChampionsPage">
                ...
                <nav class="nav2">
                    <div>
                        ...
                        <div>
                            ...
                            <a href="https://www.op.gg/champions" id="current-page" class="LanguageDependant">Champions</a>
            ...
            <div id="ChampsHeader">
                <div id="ChampsHeaderContent">
                    <div id="ChampsHeaderTitle">
                        <span>CHOOSE A CHAMPION!</span>
                    </div>
                    <span>With more than 140 champions, you'll find the perfect one for your playstyle. Master one, or all of them.</span>
                    ...
                    <nav id="filterBar">
                        <div id="filterSDP"> 
                            <section id="version">
                                ...
                                <span class="selectedOptionText">All</span>
                                <div class="arrow close"></div>
                            </section>
                            <div id="VersionList" class="hidden">
                                <span class="VersionOption">Easy</span>
                                <span class="VersionOption">Medium</span>
                                <span class="VersionOption">Hard</span>
                                <span class="VersionOption">All</span>
                            </div>

                        </div>  

                        <div id="filterRole">
                            <span data-role="all" class="selected">All</span>
                            <span data-role="top">Tank</span>
                            <span data-role="jungle">Fighter</span>
                            <span data-role="jungle">Assassin</span>
                            <span data-role="middle">Mage</span>
                            <span data-role="bottom">Marksman</span>
                            <span data-role="support">Support</span>
                        </div>
                    </nav>

                    <div id="champContainer">
                        <div id="champList">
                        <form id="champForm" action="http://127.0.0.1/champ.php" method="post">
                                <input type="hidden" name="champName" value="">
